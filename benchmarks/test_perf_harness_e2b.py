...
def main():
    print("=" * 70)
    print("TPM-MLX vs Ollama Performance Benchmark Harness (Gemma 4 e2b)")
    print("=" * 70)
    ...
    print("Warming up Ollama (gemma4:e2b)...")
    query_ollama_stream("gemma4:e2b", warmup_msg, max_tokens=10)
    ...
    for case in TEST_CASES:
        ...
        ollama_res = query_ollama_stream("gemma4:e2b", case["messages"], max_tokens=max_tokens)
    ...
    report_lines = [
        "# TPM-MLX vs Ollama Performance Report (Gemma 4 e2b)",
        "",
        "Conducted performance benchmarks comparing **TPM-MLX** (`mlx-community/gemma-4-e2b-it-4bit`) against **Ollama** (`gemma4:e2b` Q4_K_M) across six structured task categories.",
        "",
    ...
    # Save to file
    report_path = Path(__file__).parent / "perf_report-e2b.md"
