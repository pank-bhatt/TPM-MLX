...
def main():
    print("=" * 70)
    print("TPM-MLX vs Ollama Performance Benchmark Harness (Gemma 4 12B)")
    print("=" * 70)
    
    # 1. Initialize MLX Engine
    mlx_model_id = "mlx-community/gemma-4-12B-it-4bit"
    ...
    query_ollama_stream("gemma4:12b", warmup_msg, max_tokens=10)
    ...
    for case in TEST_CASES:
        ...
        ollama_res = query_ollama_stream("gemma4:12b", case["messages"], max_tokens=max_tokens)
    ...
    report_lines = [
        "# TPM-MLX vs Ollama Performance Report (Gemma 4 12B)",
        "",
        "Conducted performance benchmarks comparing **TPM-MLX** (`mlx-community/gemma-4-12B-it-4bit`) against **Ollama** (`gemma4:12b` Q4_K_M) across six structured task categories.",
        "",
    ...
    # Save to file
    report_path = Path(__file__).parent / "perf_report-12b.md"
